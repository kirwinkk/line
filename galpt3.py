...
helpMessage =""" gal.pt  􀔃􀄆red check mark􏿿

􀔃􀅕red arrow right􏿿 Public
[.me.]       Cek Akun Sendiri
[.mymid.]   Cek Akun MID
[.chk.]     Cek Akun Bot
[.gid.] Cek Id Group
[.ginfo.]    Group Info
[.midall.]   Cek All MID Bot
[.mid1/2/3/4.] Cek MID Bot
[.resp.]   Cek Respon Bot
[.botspeed.] Cek Kecepatan Bot
[.spam.]       Fungsi Spam Chat
[.tagall.]   Mention Semua User
[.banlist.]  Cek List Akun Banned
[.gn. (namagroup)] Ganti Nama Group
[.cancel.] Cancel User Masuk Group
[.setview.] Cek Privasi Group
[.openurl.]  Membuka Url Group
[.closeurl.] Menutup Url Group

􀔃􀅕red arrow right􏿿 Private
[.?.] Keywords
...
[.nk @]   Kick Target User
[.inv. (mid)] Invite via MID
[.kick. (mid)] Kick via MID
[.joinall.] Invite Semua Bot
[.1/2/3/4join.] Invite Bot
[.outall.]  All Bot Left
[.out2/3/4.] Bot 2/3/4 Left
"""

Setgroup =""" Group Settings 􀔃􀄆red check mark􏿿
...
Bots=[mid]
admin=["uc772a6893813833e0e990044f6cac302"]
owner=["uc772a6893813833e0e990044f6cac302"]
...
def bot(op):
	...
	if op.type == 26:
		...
		ki.sendMessage(msg)
		kk.sendMessage(msg)
	    elif msg.text in ["Hadeuh","hadeuh","Haduh","haduh","Waduh","Wadu","waduh","wadu","Wadudu","wadudu","Aduh","aduh","Adudu","adudu"]:
		msg.contentType = 7
		msg.text = None
		msg.contentMetadata = {
                    "STKID": "6",
		...
		ki.sendMessage(msg)
		kk.sendMessage(msg)
	    elif msg.text in ["Please","please","Plis","plis"]:
		msg.contentType = 7
		msg.text = None
		msg.contentMetadata = {
                    "STKID": "4",
	...
	#----------------Fungsi Kick User Target Finish----------------------#      
		...
		if msg.from_ in admin:
			...
			if targets == []:
			    ...
			    ki.sendText(msg.to,"0")
			    kk.sendText(msg.to,"0")
			    kc.sendText(msg.to,"0")
			else:
			    for target in targets:
				try:
				    wait["blacklist"][target] = True
...
#-----------------------------------------------
    ...
    #-------------Fungsi Bannlist Start------------------#          
		...
		if wait["blacklist"] == {}:
		    ...
		    ki.sendText(msg.to,"Blacklist user(s)")
		    mc = ""
